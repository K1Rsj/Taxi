            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item text-center" >
                        <a href="${pageContext.request.contextPath}/taxi/make_order_page"><fmt:message key="make.order"/></a>
                    </li>
                    <li class="nav-item text-center" >
                        <a href="${pageContext.request.contextPath}/taxi/my_orders"><fmt:message key="my.orders"/></a>
                    </li>
                    <li class="nav-item text-center">
                        <a href="${pageContext.request.contextPath}/taxi/my_discount"><fmt:message key="my.discount"/></a>
                    </li>
                    <li class="nav-item text-center">
